...
**Hybrid**: run both, normalize scores to [0,1], take a weighted combination. Consistently outperforms either approach alone.
...
Where `k=60` is a constant that dampens the impact of top-ranked documents. This simple formula consistently outperforms learned fusion weights in practice.

...
def recommend(req: FeatureRequirements) -> Recommendation:
    ...
    if req.labeled_examples_available < 100:
        warnings.append(f"Only {req.labeled_examples_available} labeled examples — need 100+ for fine-tuning")
        return Recommendation(
    ...
    if req.budget_usd < 5000:
        warnings.append(f"Budget ${req.budget_usd} may be insufficient for fine-tuning + maintenance")
        return Recommendation(

...
**Defense mechanisms:**
- Instruction-position defense: put critical instructions at the END of the system prompt, not the beginning. Models give more weight to recent instructions

...
<img id="error-handling-decision-tree" src="/images/error-handling-decision-tree.png" alt="Error Handling Decision Tree" />
...
<img id="llm-call-flow-rts" src="/images/llm-call-flow-rts.png" alt="LLM Call Flow: Request to Success" />

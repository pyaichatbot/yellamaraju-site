...
Read the modules in order unless you already have production LLM experience. Each module has a summary, mental model, mistakes to avoid, and a hands-on exercise. Use the [assessment guide](./enterprise-assessment-guide.md) to turn exercises into graded enterprise training artifacts.
...
| File | Topics |
|------|--------|
| [`01-foundations/01-llm-basics.md`](./01-foundations/01-llm-basics.md) | What an LLM is, ecosystem, conversations, basic capabilities |
| [`01-foundations/02-how-models-work.md`](./01-foundations/02-how-models-work.md) | Neural networks, training, inference, architecture overview |
| [`01-foundations/03-tokens-tokenization.md`](./01-foundations/03-tokens-tokenization.md) | Tokens, token budgets, costs, tokenizer behavior |
| [`01-foundations/04-10-remaining-foundations.md`](./01-foundations/04-10-remaining-foundations.md) | Context windows, embeddings, transformers, attention, parameters, training vs inference, open vs closed models |
...
| File | Topics |
|------|--------|
| [`02-datasets-training/complete-module-02.md`](./02-datasets-training/complete-module-02.md) | SFT, instruction tuning, preference data, synthetic data, curation, formatting, fine-tuning basics, continued pretraining, hallucination reduction |
...
| File | Topics |
|------|--------|
| [`03-fine-tuning/complete-module-03.md`](./03-fine-tuning/complete-module-03.md) | LoRA, QLoRA, DPO, RLHF, quantization, checkpoints, adapters, GGUF |
...
| File | Topics |
|------|--------|
| [`04-inference-optimization/complete-module-04.md`](./04-inference-optimization/complete-module-04.md) | KV cache, Flash Attention, speculative decoding, serving, batching, GPU/VRAM, latency-quality tradeoffs |
...
| File | Topics |
|------|--------|
| [`05-local-ai-ecosystem/complete-module-05.md`](./05-local-ai-ecosystem/complete-module-05.md) | llama.cpp, Ollama, vLLM, MLX, Hugging Face, Unsloth, Axolotl, PEFT/TRL |
...
| File | Topics |
|------|--------|
| [`06-rag-memory/complete-module-06.md`](./06-rag-memory/complete-module-06.md) | RAG, vector databases, chunking, retrieval pipelines, memory systems, semantic search |
...
| File | Topics |
|------|--------|
| [`07-agents-workflows/complete-module-07.md`](./07-agents-workflows/complete-module-07.md) | Prompt engineering, system prompts, tool/function calling, agents, agentic workflows, multi-agent systems, browser agents |
...
| File | Topics |
|------|--------|
| [`08-model-types/complete-module-08.md`](./08-model-types/complete-module-08.md) | Vision-language models, small language models, dense vs MoE, coding models, reasoning models |
...
| File | Topics |
|------|--------|
| [`09-deployment/complete-module-09.md`](./09-deployment/complete-module-09.md) | Local inference, on-device AI, API serving, cloud GPUs, edge AI |
...
| File | Topics |
|------|--------|
| [`10-evaluation/complete-module-10.md`](./10-evaluation/complete-module-10.md) | Benchmarks, custom evals, human evals, LLM-as-judge, cost analysis, speed-quality benchmarking |
...
| File | Topics |
|------|--------|
| [`11-real-world-skills/complete-module-11.md`](./11-real-world-skills/complete-module-11.md) | Chatbots, copilots, automation, AI SaaS workflows, coding workflows, orchestration, product thinking, final capstone |
...
| File | Topics |
|------|--------|
| [`12-enterprise-governance/complete-module-12.md`](./12-enterprise-governance/complete-module-12.md) | AI risk classification, data governance, model/vendor governance, security architecture, eval gates, monitoring, incident response, change management |
...
| File | Topics |
|------|--------|
| [`00-design-patterns-antipatterns.md`](./00-design-patterns-antipatterns.md) | Production patterns, anti-patterns, decision tables, scenarios |
...
- [Enterprise Assessment Guide](./enterprise-assessment-guide.md): objectives, rubrics, quizzes, capstone scoring, and facilitator checklist.
- [Module 12 - Enterprise Governance & Operations](./12-enterprise-governance/complete-module-12.md): governance and operations module.
- [Design Patterns & Anti-Patterns](./00-design-patterns-antipatterns.md): field reference for implementation reviews.

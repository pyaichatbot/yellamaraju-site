...
Default visual IP is "The Worker"—a simple humanoid figure, entirely solid black, minimalist stick-sketch style. Head with white dot eyes, narrow torso, thin arms with small hands, thin legs. Like a thick-brush stick figure, slightly wobbly hand-drawn, recognizably human. The Worker does strange but logical work and must actively participate in the core action, never just stand as decoration.
